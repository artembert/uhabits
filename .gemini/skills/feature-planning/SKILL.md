...
description: Create a comprehensive implementation plan for a new feature using the PRP (Problem, Relevance, Plan) format. Use when starting a new feature to ensure thorough planning and adherence to project standards.
---
